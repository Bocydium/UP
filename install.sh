...
echo ""
echo "up is self-contained: it downloads and extracts packages"
echo "directly from Arch mirrors. No pacman subprocess spam."
echo ""
echo "Quick start:"
echo "  up inst neovim       # Install from official repos or AUR"
echo "  up plan              # Dry-run pending updates"
echo "  up upda              # Update everything"
echo "  up diff neovim       # Preview file changes"
echo "  up tree neovim       # Show dependency tree"
